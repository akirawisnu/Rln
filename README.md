...
A compact, Stata-like command language for cleaning, exploring, describing, visualizing,
...
- 📂 **Read anything** — CSV, Stata `.dta`, Excel (`.xlsx`/`.xls`), Parquet, JSON, and more
...
- 📝 **Reproducible do-files** — multi-line scripts with syntax highlighting
...
language; the same do-files run identically on desktop and mobile.
...
| Explore &amp; describe | Larger-than-RAM (2M rows) | Do-file editor |
|:---:|:---:|:---:|
| <img src="media/1-console-exploration.png" width="230"/> | <img src="media/5-lrtm-2million-rows.png" width="230"/> | <img src="media/6-do-file-editor.png" width="230"/> |
